        ...
        <ul class="nav nav-pills nav-stacked">
            <li>
                ...
                <ul style="list-style-type: none;">
                    <a href="<?php echo site_url('un/lihat');?>"><li class="sidebar-list green-tosca"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-th"></span></td><td>Pengumuman Nilai UN/US</td></tr></table></li></a>
                ...
                <?php
                    ...
                    $start_umum = mktime(0, 0, 0, 7, 6, 2015);
                    $start_pemenuhan = mktime(0, 0, 0, 7, 9, 2015);
                ?>
                <ul style="list-style-type: none;">
                    <a href="<?php echo site_url('unduhbukti');?>"><li class="sidebar-list red-dark"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-download"></span></td><td>Unduh Bukti Pendaftaran</td></tr></table></li></a>
                    <a href="<?php echo site_url('rekap/beranda');?>"><li class="sidebar-list red-dark"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-list-alt"></span></td><td>Rekap Pendaftaran</td></tr></table></li></a>
                    <?php if($currentTime > $start_umum) {?>
                        <a href="<?php echo site_url('umum/pilihhasil');?>"><li class="sidebar-list red-dark"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-th-large"></span></td><td>Hasil Seleksi PPDB</td></tr></table></li></a>
                    <?php } ?>
                    <?php if($currentTime > $start_pemenuhan) {?>
                        <a href="<?php echo site_url('umum/pengumumanpemenuhanpagu');?>"><li class="sidebar-list red-dark"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-th-large"></span></td><td>Hasil Seleksi Pemenuhan Pagu</td></tr></table></li></a>
                    <?php } ?>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul style="list-style-type: none;">
                    ...
                    <a href="<?php echo site_url('umum/prosedur');?>"><li class="sidebar-list red-dark"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-question-circle"></span></td><td>Prosedur Pendaftaran</td></tr></table></li></a>
            ...
            <li>
                ...
                <ul style="list-style-type: none;">
                    ...
                    <a href="<?php echo site_url('umum/statistik2015');?>"><li class="sidebar-list red-dark"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-bar-chart"></span></td><td>Statistik 2015</td></tr></table></li></a>
                    <a href="<?php echo site_url('umum/un2012');?>"><li class="sidebar-list blue-light"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-th"></span></td><td>Sebaran NUN 2012</td></tr></table></li></a>
                    <a href="<?php echo site_url('umum/un2013');?>"><li class="sidebar-list blue-light"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-th"></span></td><td>Sebaran NUN 2013</td></tr></table></li></a>
                    <a href="<?php echo site_url('umum/un2014');?>"><li class="sidebar-list blue-light"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-th"></span></td><td>Sebaran NUN 2014</td></tr></table></li></a>
                    <a href="<?php echo site_url('umum/un2015');?>"><li class="sidebar-list blue-light"><table><tr><td valign="top"><span style="margin-right:10px;" class="fa fa-th"></span></td><td>Sebaran NUN/NUS 2015</td></tr></table></li></a>
                </ul>
            </li>
            <li>
                <a><b>Lain-lain</b></a>
