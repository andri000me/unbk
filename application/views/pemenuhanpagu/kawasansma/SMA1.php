    ...
    <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <?php echo form_open('hasil/pemenuhanpagu/kawasan/sma', array('id' => 'formCari', 'class' => 'form-inline')); ?>
                    <div class="input-control text">
                        ...
                        echo form_dropdown('sekolah', $options, 'SMA1', 'class="form-control"'); ?>
                        <button class="btn btn-info"  onclick="document.getElementById('formCari').submit()" style="cursor: pointer"><span style="margin-right:10px;" class="fa fa-search"></span>Cari</button>
                    </div>
                <?php echo form_close(); ?>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12" style="max-height: 500px; overflow-y: auto;">
                <h2>Hasil Pemenuhan Pagu SMA Negeri 1</h2>
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                         <tr>
                          <td>1</td>
                          <td>21405011860169</td>
                          <td>Ilham Az Zilzal Bustomi</td>
                          <td>SMP NEGERI 37 SURABAYA</td>
                          <td>119.48</td>
                         </tr>
                         <tr>
                          <td>2</td>
                          <td>21405010111352</td>
                          <td>MISI LILIANA DEWI</td>
                          <td>SMP NEGERI 4 SURABAYA</td>
                          <td>119.39</td>
                         </tr>
                         <tr>
                          <td>3</td>
                          <td>21405011481192</td>
                          <td>ANGELIA NISFIA RAHMAWATI DEWI</td>
                          <td>SMP NEGERI 29 SURABAYA</td>
                          <td>119.25</td>
                         </tr>
                         <tr>
                          <td>4</td>
                          <td>21405013351734</td>
                          <td>IFTITACHUL WARDANA AYU ARISANTI</td>
                          <td>SMP NEGERI 43 SURABAYA</td>
                          <td>118.83</td>
                         </tr>
                    </tbody>
                </table>
