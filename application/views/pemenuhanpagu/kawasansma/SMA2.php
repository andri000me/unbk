    ...
    <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <?php echo form_open('hasil/pemenuhanpagu/kawasan/sma', array('id' => 'formCari', 'class' => 'form-inline')); ?>
                    <div class="input-control text">
                        ...
                        echo form_dropdown('sekolah', $options, 'SMA2', 'class="form-control"'); ?>
                        <button class="btn btn-info"  onclick="document.getElementById('formCari').submit()" style="cursor: pointer"><span style="margin-right:10px;" class="fa fa-search"></span>Cari</button>
                    </div>
                <?php echo form_close(); ?>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12" style="max-height: 500px; overflow-y: auto;">
                <h2>Hasil Pemenuhan Pagu SMA Negeri 2</h2>
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                       <tr>
                          <td>1</td>
                          <td>21405010210952</td>
                          <td>ADENEGARA RIZKY GUSTI PRATAMA</td>
                          <td>SMP NEGERI 6 SURABAYA</td>
                          <td>128.39</td>
                         </tr>
                         <tr>
                          <td>2</td>
                          <td>21405010211005</td>
                          <td>EDO TRIARFIANDA EDVANKA</td>
                          <td>SMP NEGERI 6 SURABAYA</td>
                          <td>128.3</td>
                         </tr>
                         <tr>
                          <td>3</td>
                          <td>21405010061698</td>
                          <td>MUHAMMAD ILHAM AL MATIN NASUTION</td>
