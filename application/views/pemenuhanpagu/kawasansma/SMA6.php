    ...
    <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <?php echo form_open('hasil/pemenuhanpagu/kawasan/sma', array('id' => 'formCari', 'class' => 'form-inline')); ?>
                    <div class="input-control text">
                        ...
                        echo form_dropdown('sekolah', $options, 'SMA6', 'class="form-control"'); ?>
                        <button class="btn btn-info"  onclick="document.getElementById('formCari').submit()" style="cursor: pointer"><span style="margin-right:10px;" class="fa fa-search"></span>Cari</button>
                    </div>
                <?php echo form_close(); ?>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12" style="max-height: 500px; overflow-y: auto;">
                <h2>Hasil Pemenuhan Pagu SMA Negeri 6</h2>
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                       <tr>
                      <td>1</td>
                      <td>21405110051494</td>
                      <td>ACHMAD RIKZA<sup>M</sup></td>
                      <td>SMP NEGERI 2 SIDOARJO</td>
                      <td>125.67</td>
                     </tr>
                     <tr>
                      <td>2</td>
                      <td>21405010061752</td>
                      <td>SAFFANAH DHAFIN PRAMIYAS</td>
                      <td>SMP NEGERI 3 SURABAYA</td>
                      <td>125.31</td>
                     </tr>
                     <tr>
                      <td>3</td>
                      <td>21405013451049</td>
                      <td>ADELLA SETIAPUTRI</td>
                      <td>SMP NEGERI 46 SURABAYA</td>
                      <td>125.3</td>
                     </tr>
                     <tr>
                      <td>4</td>
                      <td>21405013450338</td>
                      <td>YUDHISTIRA PAKSI RULLY ADJIE</td>
                      <td>SMP NEGERI 46 SURABAYA</td>
                      <td>125.3</td>
                     </tr>
                     <tr>
                      <td>5</td>
                      <td>21405010062258</td>
                      <td>YASMIN AISYAH AKILAH RAHMAN</td>
                      <td>SMP NEGERI 3 SURABAYA</td>
                      <td>125.21</td>
                     </tr>
                    </tbody>
