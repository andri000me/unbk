    ...
    <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <?php echo form_open('hasil/pemenuhanpagu/kawasan/sma', array('id' => 'formCari', 'class' => 'form-inline')); ?>
                    <div class="input-control text">
                        ...
                        echo form_dropdown('sekolah', $options, 'SMA11', 'class="form-control"'); ?>
                        <button class="btn btn-info"  onclick="document.getElementById('formCari').submit()" style="cursor: pointer"><span style="margin-right:10px;" class="fa fa-search"></span>Cari</button>
                    </div>
                <?php echo form_close(); ?>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12" style="max-height: 500px; overflow-y: auto;">
                <h2>Hasil Pemenuhan Pagu SMA Negeri 11</h2>
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                          <td>1</td>
                          <td>21405011023289</td>
                          <td>NOVITA TRI WIRANTI</td>
                          <td>SMP NEGERI 20 SURABAYA</td>
                          <td>106.7</td>
                         </tr>
                         <tr>
                          <td>2</td>
                          <td>21405011021005</td>
                          <td>MUHAMMAD AKHMAL ALAMSYAH DARMAWAN</td>
                          <td>SMP NEGERI 20 SURABAYA</td>
                          <td>106.51</td>
                         </tr>
                         <tr>
                          <td>3</td>
                          <td>21405012540347</td>
                          <td>SUTARITA KRISMONICA OKTAVIA</td>
                          <td>SMP TAMAN PELAJAR</td>
                          <td>106.43</td>
                         </tr>
                    </tbody>
                </table>
