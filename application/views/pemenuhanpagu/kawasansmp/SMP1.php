    ...
    <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <?php echo form_open('hasil/pemenuhanpagu/kawasan/smp', array('id' => 'formCari', 'class' => 'form-inline')); ?>
                    <div class="input-control text">
                        ...
                        echo form_dropdown('sekolah', $options, 'SMP1', 'class="form-control"'); ?>
                        <button class="btn btn-info" onclick="document.getElementById('formCari').submit()" style="cursor: pointer"><span style="margin-right:10px;" class="fa fa-search"></span>Cari</button>
                    </div>
                <?php echo form_close(); ?>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12" style="max-height: 500px; overflow-y: auto;">
                <h2>Hasil Pemenuhan Pagu SMP Negeri 1</h2>
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                        <td>1</td>
                        <td>11405011610134</td>
                        <td>I NYOMAN GEDE ISMAYANA</td>
                        <td>SDN PACARKELING V/186</td>
                        <td>146.06</td>
                       </tr>
                       <tr>
                        <td>2</td>
                        <td>11405014130276</td>
                        <td>SAMANTHA ISMILLAH SAMIRANA ASTHA.WIBISANA</td>
                        <td>SDN KUPANG KRAJAN I</td>
                        <td>145.97</td>
                       </tr>
                       <tr>
                        <td>3</td>
                        <td>11405012060027</td>
                        <td>AKILLA NATHANIA MELATI</td>
                        <td>SDN KERTAJAYA</td>
                        <td>145.8</td>
                       </tr>
                       <tr>
                        <td>4</td>
                        <td>11405011560027</td>
                        <td>AISYAH NUR SAHAR</td>
                        <td>SDN RANGKAH VI / 168</td>
                        <td>145.79</td>
                       </tr>
                       <tr>
                        <td>5</td>
                        <td>11405011561414</td>
                        <td>BINTANG ARYA SENA</td>
                        <td>SDN RANGKAH VI / 168</td>
                        <td>145.77</td>
                       </tr>
                       <tr>
                        <td>6</td>
                        <td>11405011560152</td>
                        <td>DIMAS SATRIA WIRAYUDHA</td>
                        <td>SDN RANGKAH VI / 168</td>
                        <td>145.73</td>
                       </tr>
                       <tr>
                        <td>7</td>
                        <td>11405010020258</td>
                        <td>NADIA ZHARFANI FADHILA</td>
                        <td>SDN KALIASIN III NO. 282</td>
                        <td>145.72</td>
                       </tr>
                    </tbody>
                </table>
