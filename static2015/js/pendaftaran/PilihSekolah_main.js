...
function changeStatusValidasi(isOnLoad) {
    ...
    if (tamatan == '1') {
        if (kk == '1') {
            ...
            statusValidasiValue = '<b>Dalam Kota</b>. ' + statusValidasiValue;
        } else if (kk == '2') {
            statusValidasiValue = '<b>Rekomendasi Dalam Kota</b>. Pagu yang tersedia adalah 1%.';
        }
    } else if (tamatan == '2') {
        if (kk == '1') {
            statusValidasiValue = '<b>Mutasi</b>';
        } else if (kk == '2') {
            statusValidasiValue = '<b>Luar Kota</b>. Pagu yang tersedia adalah 1%.';
        }
    }
